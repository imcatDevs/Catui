...
declare interface SecurityUtil {
  ...
  sanitizeParam(value: any): any;
}

// ===== Utils Types =====

declare interface UtilsNamespace {
...
declare interface HelpersNamespace {
...
// ===== EventEmitterMixin Types =====

declare interface EventEmitterTarget {
...
declare interface EventEmitterMixin {
  apply(target: object): void;
  create(): EventEmitterTarget;
}
...
declare interface IMCAT {
  ...
  readonly helpers: HelpersNamespace;
  readonly security: SecurityUtil;
