var IMCAT = (function () {
  ...
  class ModuleLoader {
    ...
    _detectDistPath() {
      ...
      try {
        if (typeof ({ url: (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('imcat-ui.js', document.baseURI).href) }) !== 'undefined' && (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('imcat-ui.js', document.baseURI).href)) {
          const url = new URL((_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('imcat-ui.js', document.baseURI).href));
