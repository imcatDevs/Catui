...
class InfiniteScroll {
  ...
  _setupObserver() {
    ...
    // 스크롤 가능한 컨테이너 감지 (overflow-y: auto|scroll)
    ...
    this._observer = new IntersectionObserver(
      ...
      {
        root: isScrollable ? this.container : null,
...
class BackToTop {
  ...
  _render() {
    ...
    this.button.innerHTML = `<i class="material-icons-outlined">${Security.escape(icon)}</i>`;
